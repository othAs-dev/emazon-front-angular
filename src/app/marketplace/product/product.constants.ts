...
export type PageContentV2 = Omit<PageContent, 'chipOptionsColors' | 'chipOptionsStorage' | 'tableData'> & {colors: string[], name: string, price: string}

export const pageContent: PageContent = {
    urlImage: [
        'assets/mabook-air.jpeg',
        'assets/mabook-air.jpeg',
        'assets/ipad-air.jpeg',
    ],
    shortDescription:
        'Design tout écran. De toute beauté. Avec l’iPad Air, plongez dans tout ce que vous lisez, regardez ou créez. Son écran Liquid Retina 10,9 pouces dispose de tech­no­lo­gies avan­cées, telles que l’affi­cha­ge True Tone, la large gamme de couleurs P3 et un revê­te­ment antireflet.',
    longDescription:
